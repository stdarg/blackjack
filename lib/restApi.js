...
function debugCredits(req, res, json) {
    var info = getInfoFromReq(req, res, json, 'debug/credits', {table: true});
    try {
...
function debugGetPlayer(req, res, json) {
    var info = getInfoFromReq(req, res, json, 'debug/getPlayer', {table:true});
    try {
        assert.ok(is.nonEmptyObj(info));
        assert.ok(is.nonEmptyObj(info.player));
    } catch(err) {
...
function debugGameState(req, res, json) {
    var info = getInfoFromReq(req, res, json, 'debug/gameState', {table:true});
    try {
        assert.ok(is.nonEmptyObj(info));
        assert.ok(is.nonEmptyObj(info.player));
    } catch(err) {
